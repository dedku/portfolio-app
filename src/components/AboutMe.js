    ...
    <Container maxW="container.xl">
      <Motion>
        ...
        >
          <Box
            w="100%"
            h={{ base: 'calc(50vh - 6rem)', md: 'calc(50vh - 8rem)' }}
            maxH="400px"
          >
            <Center h="100%">
              <Container>
                <Box display="flex">
                  ...
                  >
                    ...
                    <Text fontFamily="JetBrains Mono  , Poppins">
                      Junior Software Craftsman
                    </Text>
                  </Box>
                </Box>
                <Spacer />
